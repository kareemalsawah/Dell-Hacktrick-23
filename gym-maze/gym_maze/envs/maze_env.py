...
class MazeEnv(gym.Env):
    ...
    def __init__(
        ...
        if hasattr(maze_cells, "shape"):
            self.maze_view = MazeView2D(
                maze_name="OpenAI Gym - Maze (10 x 10)",
    ...
    def reset(self):
        ...
        self.state = [
            ...
            self.maze_view.get_rescue_items_locations()[0],
            self.maze_view.get_rescue_items_locations()[1],
        ]
        self.steps_beyond_done = None
        self.steps = 0
...
class MazeEnvSample5x5(MazeEnv):
    def __init__(self, enable_render=True, maze_cells=None, rescue_item_locations=None):
        super(MazeEnvSample5x5, self).__init__(
            ...
            enable_render=enable_render,
            maze_cells=maze_cells,
            rescue_item_locations=rescue_item_locations,
        )
